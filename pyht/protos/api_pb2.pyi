...
class Credentials(_message.Message):
    ...
    id: str
    token: bytes
    def __init__(self, id: _Optional[str] = ..., token: _Optional[bytes] = ...) -> None: ...
...
class TtsParams(_message.Message):
    __slots__ = ("text", "voice", "quality", "format", "sample_rate", "speed", "seed", "temperature", "top_p", "style_guidance", "voice_guidance", "audio_source", "speaker_attributes", "speech_attributes", "language_identifier", "text_guidance", "other")
    ...
    STYLE_GUIDANCE_FIELD_NUMBER: _ClassVar[int]
    VOICE_GUIDANCE_FIELD_NUMBER: _ClassVar[int]
    AUDIO_SOURCE_FIELD_NUMBER: _ClassVar[int]
    SPEAKER_ATTRIBUTES_FIELD_NUMBER: _ClassVar[int]
    SPEECH_ATTRIBUTES_FIELD_NUMBER: _ClassVar[int]
    ...
    audio_source: int
    speaker_attributes: int
    speech_attributes: int
    language_identifier: int
    text_guidance: float
    other: str
    def __init__(self, text: _Optional[_Iterable[str]] = ..., voice: _Optional[str] = ..., quality: _Optional[_Union[Quality, str]] = ..., format: _Optional[_Union[Format, str]] = ..., sample_rate: _Optional[int] = ..., speed: _Optional[float] = ..., seed: _Optional[int] = ..., temperature: _Optional[float] = ..., top_p: _Optional[float] = ..., style_guidance: _Optional[float] = ..., voice_guidance: _Optional[float] = ..., audio_source: _Optional[int] = ..., speaker_attributes: _Optional[int] = ..., speech_attributes: _Optional[int] = ..., language_identifier: _Optional[int] = ..., text_guidance: _Optional[float] = ..., other: _Optional[str] = ...) -> None: ...
